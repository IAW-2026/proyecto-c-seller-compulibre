...
Aplicación **Seller** del [Proyecto IAW 2026](https://iaw-2026.github.io/proyecto/) — comisión `CompuLibre`.
...
La documentación del proyecto se encuentra en la carpeta proyecto-c-seller-compulibre.
[Ver documentación de Seller App](./proyecto-c-seller-compulibre/README.md)
